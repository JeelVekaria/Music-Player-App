...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface
{
	...
	{
		// creates a Song object from given parameter
		Song otherSong = (Song) other;

		// compares thier composer, artist, and audioContent
		if(this.composer.equals(otherSong.getComposer()) && this.artist.equals(otherSong.getArtist()) && super.equals(otherSong)){
			return true;	
		} 
		return false;
	}
	...
	{
		// compares 2 songs based on their title
		Song otherSong = (Song) other;
	...
	public String toString() {
		String result = super.getTitle()+" "+super.getYear()+" "+super.getId()+" "+"SONG"+" "+super.getAudioFile()+" "+super.getLength()+" "+artist+" "+composer+" "+genre+" "+lyrics;
		return result;
	}
}
